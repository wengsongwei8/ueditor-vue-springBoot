package com.weng.ueditor.ueditor;

import com.weng.ueditor.ueditor.define.ActionMap;
...
public final class ConfigManager {
	...
	private void initEnv () throws FileNotFoundException, IOException {
		...
		/*try {
			LOGGER.info("==========开始==============");
			LOGGER.info("==========中间:============="+ResourceUtils.getFile("classpath:config.json").getAbsolutePath());
			LOGGER.info("==========结束==============");
		}catch (Exception e){
			LOGGER.info("",e);
		}*/
		InputStream configIs =  this.getClass().getResourceAsStream("/config.json");
		//String configPath = this.getClass().getResourceAsStream("/config.json");
		String configContent =  this.getContent(configIs);//this.readFile( configPath );
